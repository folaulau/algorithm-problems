...
public class ValidParentheses {
  ...
  /**
   * Solution<br>
   * The idea is to put all the open parentheses in the stack. Whenever you hit a closing bracket,
   * check if the top of the stack is the opening bracket of the same nature. If this is true then
   * pop the stack and continue the iteration, in the end if the stack is empty, it means all open
   * parentheses found their closing parentheses. Otherwise, they are not correct.<br>
   * 
   * 
   ...
   * 4. If not, pop in a closing parenthesis if the top of the stack contains the corresponding open
   * parenthesis.<br>
   * 5. If the parentheses are valid,​ then the stack will be empty once the input string
   * finishes.<br>
   * 
